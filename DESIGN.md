...
## 3. Typography Rules
### Font Family
- **Headline / Display**: `Outfit_700Bold`, with fallbacks: `Outfit_600SemiBold, Outfit_500Medium, Outfit_400Regular, system-ui, Helvetica Neue, Helvetica, Arial, sans-serif`
- **Body / UI**: `Outfit_400Regular` / `Outfit_500Medium`, with fallbacks: `system-ui, Helvetica Neue, Helvetica, Arial, sans-serif`
*Note: Outfit is used as the custom font family. Outfit_700Bold for bold headlines, Outfit_600SemiBold / Outfit_500Medium for medium weights, and Outfit_400Regular for body/UI text.*
### Hierarchy
| Role | Font | Size | Weight | Line Height | Notes |
|------|------|------|--------|-------------|-------|
| Display / Hero | Outfit_700Bold | 52px (3.25rem) | 700 | 1.23 (tight) | Maximum impact, billboard presence |
| Section Heading | Outfit_700Bold | 36px (2.25rem) | 700 | 1.22 (tight) | Major section anchors |
| Card Title | Outfit_700Bold | 32px (2rem) | 700 | 1.25 (tight) | Card and feature headings |
| Sub-heading | Outfit_700Bold | 24px (1.5rem) | 700 | 1.33 | Secondary section headers |
| Small Heading | Outfit_700Bold | 20px (1.25rem) | 700 | 1.40 | Compact headings, list titles |
| Nav / UI Large | Outfit_500Medium | 18px (1.13rem) | 500 | 1.33 | Navigation links, prominent UI text |
| Body / Button | Outfit_400Regular / Outfit_500Medium | 16px (1rem) | 400-500 | 1.25-1.50 | Standard body text, button labels |
| Caption | Outfit_400Regular / Outfit_500Medium | 14px (0.88rem) | 400-500 | 1.14-1.43 | Metadata, descriptions, small links |
| Micro | Outfit_400Regular | 12px (0.75rem) | 400 | 1.67 (relaxed) | Fine print, legal text |
### Principles
- **Bold headlines, medium body**: Outfit_700Bold headings are exclusively weight 700 (bold) -- every headline hits with billboard force. Outfit_400Regular / Outfit_500Medium body and UI text uses 400-500, creating a clear visual hierarchy through weight contrast.
...
- **Two fonts, strict roles**: Outfit_700Bold is exclusively for headings. Outfit_400Regular / Outfit_500Medium is exclusively for body, buttons, links, and UI. The boundary is never crossed.
...
- Use 8px radius for content cards and 12px for featured containers
